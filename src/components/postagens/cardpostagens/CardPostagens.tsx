...
function CardPostagens({ postagem }: CardPostagensProps) {  // Passamos a props postagem para o card
  return (
    <div className="border-slate-900 border flex flex-col rounded overflow-hidden justify-between">
      ...
      <div>
        ...
        <div className="flex">
          <Link to={`/editarpostagem/${postagem.id}`} className="w-full text-white bg-indigo-400
